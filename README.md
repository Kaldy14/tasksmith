...
- fresh-context diff review with structured findings, blocking severe findings, and bounded review-fix attempts,
...
- GitHub CI polling and bounded CI-fix attempts after ready PR creation,
